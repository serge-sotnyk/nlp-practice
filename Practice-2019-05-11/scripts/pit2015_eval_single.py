...
def EvalSingleSystem(testlabelfile, outputfile):
    ...
    if hasscore == False:
        evalresult = testsize + bar + teamname + bar + nameofrun + bar + bar + "F: {0:.3f}".format(
            F) + bar + "Prec: {0:.3f}".format(P) + bar + "Rec: {0:.3f}".format(R) \
    ...
    evalresult = testsize + bar + teamname + bar + nameofrun + bar + bar + "F: {0:.3f}".format(
        F) + bar + "Prec: {0:.3f}".format(P) + bar + "Rec: {0:.3f}".format(R) \
                 + bar + bar + "P-corr: {0:.3f}".format(
        pcorrelation) + bar + "F1: {0:.3f}".format(maxF1) + bar + "Prec: {0:.3f}".format(
        P_maxF1) + bar + "Rec: {0:.3f}".format(R_maxF1)
