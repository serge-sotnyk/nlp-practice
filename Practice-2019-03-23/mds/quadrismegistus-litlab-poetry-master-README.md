...
***This code evolved in 2018 into [Poesy](https://github.com/quadrismegistus/poesy), a cleaner and improved module for poetic processing. The code here is now deprecated and it is recommended you use [Poesy](https://github.com/quadrismegistus/poesy) instead.***
