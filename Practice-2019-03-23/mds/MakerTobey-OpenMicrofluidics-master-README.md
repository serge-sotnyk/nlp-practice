...
This projekt is run as part of my current Fellowship Freies Wissen (translates to Open Knowledge), here is the [project description on the corresponding Wikiversity page](https://de.wikiversity.org/wiki/Wikiversity:Fellow-Programm_Freies_Wissen/Einreichungen/Open_labware_for_better_life_science) and see the file Roadmap.md as well as the [intermediate report](https://de.wikiversity.org/wiki/Wikiversity:Fellow-Programm_Freies_Wissen/Einreichungen/Open_labware_for_better_life_science/Zwischenbericht).
