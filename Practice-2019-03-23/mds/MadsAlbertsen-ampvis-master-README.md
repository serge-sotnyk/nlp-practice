...
### 1.27.0
#### Enhancements
 - amp_heatmap: `round` makes it possible to control the number of digits plotted (default: 1).
...
#### Enhancements
 ...
 - amp_heatmap: Due to popular demand the default color scheme have been reversed! Red now equals abundant!
